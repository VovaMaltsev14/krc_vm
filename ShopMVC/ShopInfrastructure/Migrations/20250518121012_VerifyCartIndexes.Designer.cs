...
namespace ShopInfrastructure.Migrations
{
    ...
    [Migration("20250518121012_VerifyCartIndexes")]
    partial class VerifyCartIndexes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ShopDomain.Model.Cart", b =>
                {
                    ...
                    b.HasIndex(new[] { "SessionId" }, "IX_carts_session_id_unique")
                        .IsUnique()
                        .HasFilter("[session_id] IS NOT NULL");

                    b.HasIndex(new[] { "UserId" }, "IX_carts_user_id_unique")
                        .IsUnique()
            ...
            modelBuilder.Entity("ShopDomain.Model.Product", b =>
                {
                    ...
                    b.Property<string>("PdImagePath")
                        .HasMaxLength(450)
                        .HasColumnType("nvarchar(450)")
                        .HasColumnName("pd_image_path");
            ...
            modelBuilder.Entity("ShopDomain.Model.Shiping", b =>
                {
                    ...
                    b.Property<string>("ShStatus")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
                        .HasColumnName("sh_status");

                    b.Property<string>("ShTrackingNumber")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
            ...
            modelBuilder.Entity("ShopDomain.Model.ShippingCompany", b =>
                {
                    ...
                    b.Property<string>("ScContactInfo")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)")
